...
class PostControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $authorValue = $crawler->filter('#blog_modelbundle_post_author option:contains("Barack")')->attr('value');
        ...
        $this->assertGreaterThan(0, $crawler->filter('[value="Updated post"]')->count(), 'Cannot find updated value');
